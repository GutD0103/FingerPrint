...
///        This function is used for check if the sides of the triangle follow the clockwise order.
        ...
        for (int j = 0; j < NumTriangle2; j++)
        {
            ...
            if (group2[j].status == 0)
            {
                ...
                if (
                    ...
                    (SubBord1AndBord1 <= _distanceLimit) && 
                    (SubBord2AndBord2 <= _distanceLimit) && 
                    (SubBord3AndBord3 <= _distanceLimit))
                {
                    ...
                    (minus1->minus[k1].Type == minus2->minus[k2].Type) && 
                    (SubBord1AndBord1 <= _distanceLimit) && 
                    (SubBord2AndBord3 <= _distanceLimit) && 
                    (SubBord3AndBord2 <= _distanceLimit))
                {
                    ...
                    (SubBord1AndBord2 <= _distanceLimit) && 
                    (SubBord2AndBord3 <= _distanceLimit) && 
                    (SubBord3AndBord1 <= _distanceLimit))
                {
                    ...
                    (minus1->minus[k1].Type == minus2->minus[j2].Type) && 
                    (SubBord1AndBord2 <= _distanceLimit) && 
                    (SubBord2AndBord1 <= _distanceLimit) && 
                    (SubBord3AndBord3 <= _distanceLimit))
                {
                    ...
                    (SubBord1AndBord3 <= _distanceLimit) && 
                    (SubBord2AndBord2 <= _distanceLimit) && 
                    (SubBord3AndBord1 <= _distanceLimit))
                {
